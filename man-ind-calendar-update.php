<?php
include "./man-UI.php";
include "./php/man-ind-cal-upd.php";
?>
...
<div class="container d-flex justify-content-center align-items-center"
    ...
    <form class="p-4 rounded-3 bg-white align-items-center"
          style="width: 50%;"
          action="php/man-ind-cal-upd.php"
          method="post">
        ...
        <div class="d-flex justify-content-center align-items-center">
            ...
            <a href="php/man-ind-cal-rem.php?id=<?=$indCalData['id']?>"
               class="btn btn-danger mx-1">Delete</a>
            <br>
            <a href="./man-home.php" class="btn btn-secondary mx-2">Back</a>
        </div>
    </form>
</div>
</body>
