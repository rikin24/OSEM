...
<body>
<h2 class="text-dark text-center p-3">Managers</h2>
<br>
<div class="d-flex justify-content-center align-items-center">
    <a href="adm-managers-add.php" class="btn btn-primary">Add Manager</a>
    <br>
</div>
<div class="d-flex justify-content-center align-items-center">
    <form class="p-4 rounded-3 bg-white align-items-center"
          action="adm-managers.php"
          method="get">
        <div class="form-group">
            <div class="mb-3 d-flex align-items-center gap-2">
                <input class="form-control" type="text" name="search" placeholder="Search managers">
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group-sm">
                            ...
                            <a href="adm-managers-update.php?id=<?=$empData['id']?>" class="btn btn-outline-primary">Update</a>
                            <a href="php/adm-man-rem.php?id=<?=$empData['id']?>"
